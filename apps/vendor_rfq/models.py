...
class VendorRFQ(models.Model):
    ...
    inquiry     = models.ForeignKey(
        'rfq.RFQ', on_delete=models.CASCADE, related_name='vendor_rfqs'
    )
    vendor      = models.ForeignKey(
        'companies.Company', on_delete=models.PROTECT, related_name='vendor_rfqs'
    )
...
class VendorRFQLine(models.Model):
    ...
    inquiry_line    = models.ForeignKey(
        'rfq.RFQLine', on_delete=models.PROTECT, related_name='vendor_lines'
    )
...
# apps/vendor_rfq/models.py  — add at the bottom
